            ...
            <table class="table table-bordered table-hover table-striped tablesorter">
                ...
                foreach ($res2 as $ress => $row) {
                    ...
                    <tr>
                        ...
                        <td><?php echo getField($usersTable, 'name', 'id', $row['user_id']) . ' ' . getField($usersTable, 'family', 'id', $row['user_id']); ?></td>
    ...
    $('.infoBtn').click(function (e) {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                setTimeout(function () {
                    window.location.href = "listen?id=" + thisId;
                }, 0);
            }
        });
    });
