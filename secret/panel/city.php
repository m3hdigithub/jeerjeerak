...
<div class="col-lg-12">
    <div class="btn-group">
        <a href="cityNew" class="btn btn-success">ایجاد شهر یا محله جدید
        </a>

        <a href="?todayCats" class="btn btn-default">
            <span class="">شهر و محله های امروز </span>
    ...
    <div class="table-responsive">
        ...
        if ($allDataForAlert) { ?>
            <div style="color: red;">توجه: با حذف هر شهر همه ی محله های آن نیز حذف خواهد شد!</div>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <span datatype="" class="btn btn-xs btn-info infoBtn"
                                                  id="<?php echo $row['id']; ?>">محله ها (<?php echo $numSubCats; ?> )</span>
                                        </div>
                                    </td>
