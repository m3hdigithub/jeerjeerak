    ...
    <div class="table-responsive">
        ...
        <table class="table table-bordered table-hover table-striped tablesorter">
            ...
            <tr>
                ...
                <!--<td class="text-center"><div style="width: 30px; height: 30px; background: <?php /*echo '#'.$row['code']; */?>;"></div></td>
                <td style="direction: ltr;"><?php /*echo '#'.$row['code']; */?></td>-->
