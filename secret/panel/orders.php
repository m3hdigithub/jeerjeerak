    ...
    <div class="table-responsive">
        ...
        <table class="table table-bordered table-hover table-striped tablesorter">
            ...
            <tr>
                ...
                <th>نام جیرجیرکی کاربر<i class="fa fa-sort"></i></th>
                <th>مبلغ<i class="fa fa-sort"></i></th>
                <th>شماره پیگیری</th>
                <th>وضعیت پرداخت</th>
                <th>تنطیمات</th>
            </tr>
            ...
            $amount = tomanFormat($row['amount']);
            $paygiriNumber = checkEmptyVar($row['peygiri_number']);
            $status = $row['status'];
            ...
            <tr>
                <td><?php echo $i; ?></td>
<!--                <td><img src='--><?php //echo $image; ?><!--' width='40' height='40' style='border: 1px solid #666666; padding: 2px; border-radius:100%;'></td>-->
                <td><a href="member?id=<?php echo $row['user_id']; ?>"><?php echo $userInfoName; ?></a></td>
                <td><?php echo $amount; ?></td>
                <td><?php echo $paygiriNumber; ?></td>
<!--                <td>--><?php //echo ($row['package_id'] !='' && $row['package_id'] !=0)?getField($packagesTable,'title','id',$row['package_id']):'-'; ?><!--</td>-->
                <td>
                    <?php if ($status == 1) { ?>
