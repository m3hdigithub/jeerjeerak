...
if (isset($_REQUEST['delete'])) {
    ...
    if ($thisID) {
        ...
        if ($deleteItem) {
            # get all images from table images
...
<div class="col-lg-12">
    <div class="btn-group">
        <!--<a href="<?php /*echo $idpage . 'New'; */ ?>" class="btn btn-success">
                ایجاد تعرفه جدید</a>-->
        <a href="?unaccept" class="btn btn-default">
            <span class=""> تعداد آگهی های تایید نشده </span>
            <span class="label label-danger"><?php echo getNotifications2($thisTable,'status','0'); ?></span>
        </a>
        <a href="?today" class="btn btn-default">
            <span class=""> تعداد آگهی های امروز </span>
            <span class="label label-danger"><?php echo getNotifications($thisTable); ?></span>
        </a>
        <a class="btn btn-primary" href="<?php echo $idpage . ''; ?>">
            <span class="">همه ی آگهی ها</span>
        </a>
    </div>
    <br><br>
    <?php if (getField($thisTable, 'COUNT(*)')) { ?>
        <div class="table-responsive">
            ...
            <table class="table table-bordered table-hover table-striped tablesorter">
                ...
                $status = $row['status'];
                $userInfoName = getField($usersTable, 'username', 'id', $row['user_id']);
                ?>
                <tr>
                    <td><?php echo $i; ?></td>
                    <td><?php echo (in_array($row['type'], array_keys($typeAdvertising))) ? $typeAdvertising[$row['type']] : '-'; ?></td>
                    <td><?php echo checkEmptyVar($row['title']); ?> </td>
                    <td><a href="member?id=<?php echo $row['user_id']; ?>"><?php echo $userInfoName; ?></a></td>

                    <td>
                        <?php if ($status == 1) { ?>
                            <span class="label label-success">تایید شده / درحال نمایش</span>
                           <!-- <div class="btn-group">
                        ...
                        <?php } else { ?>
                            <span class="label label-danger">تایید نشده / عدم نمایش</span>
                            <!--<div class="btn-group">
                    ...
                    <td><?php echo getTimeLang($row['update_time']); ?></td>
