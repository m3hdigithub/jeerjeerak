...
?>
<div class="col-lg-12">
    <div class="text-center"><h2>جزئیات پیام</h2></div>
    <hr>
    <div class="table-responsive">
        ...
        <table class="table table-bordered table-hover table-striped tablesorter">
            ...
            if ($information) {
                ...
                if (!$status){
                    $db->query("UPDATE $thisTable SET status='1' WHERE id='$getID'");
                }
                ?>
                <tr>
                    <td>نام و نام خانوادگی</td>
                    <td><?php echo ($userInfo['name'] !='')?$userInfo['name']:'<i class="fa fa-times-circle fa-2x">'; ?></td>
                </tr>
                <tr>
                    <td>پست الکترونیکی</td>
                    <td><?php echo ($userInfo['email'] && $userInfo['email'] !='')?$userInfo['email']:'<i class="fa fa-times-circle fa-2x">'; ?></td>
                </tr>
                <tr>
                    <td>شماره موبایل</td>
                    <td><?php echo ($userInfo['mobile'] && $userInfo['mobile'] !='')?$userInfo['mobile']:'<i class="fa fa-times-circle fa-2x">'; ?></td>

                </tr>
                <tr>
                    <td>موضوع</td>
                    <td><?php echo ($userInfo['subject'] && $userInfo['subject'] !='' && $userInfo['subject'] !='0')?$subjectContact[$userInfo['subject']]:'<i class="fa fa-times-circle fa-2x">'; ?></td>

                </tr>
                <tr>
                    <td>متن پیام</td>
                    <td><?php echo ($userInfo['message'] && $userInfo['message'] !='')?$userInfo['message']:'<i class="fa fa-times-circle fa-2x">'; ?></td>
                </tr>
