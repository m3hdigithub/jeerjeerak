...
<div class="col-lg-12">
    <div class="btn-group">
        <a href="companyNew" class="btn btn-success">ایجاد دسته بندی جدید</a>

        <a href="?todayCats" class="btn btn-default">
            <span class="">دسته بندی های امروز </span>
    ...
    <div class="table-responsive">
        ...
        if ($allDataForAlert) {
            ...
            ?>
            <div style="color: red;">توجه: با حذف دسته بندی اصلی همه ی زیر دسته های آن نیز حذف خواهد شد!</div>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <span datatype="" class="btn btn-xs btn-info infoBtn"
                                                  id="<?php echo $row['id']; ?>">زیردسته ها(<?php echo $numSubCats; ?>
                                                )</span>
                                        </div>
                                    </td>
