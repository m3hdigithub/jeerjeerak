            ...
            <table class="table table-bordered table-hover table-striped tablesorter">
                ...
                foreach ($res2 as $ress => $row) {
                    ...
                    <tr>
                        ...
                        <td><?php echo getField($companyTable, 'title', 'id', $row['company_id']); ?></td>
                        <td><?php echo getField($companyTable, 'title', 'id', $row['model']); ?></td>
                        <td><?php echo jdate('Y/m/d ساعت H:i:s', strtotime($row['create_time'])); ?></td>
                        <td><?php echo jdate('Y/m/d ساعت H:i:s', strtotime($row['update_time'])); ?></td>

                        <td>
                            <div class="btn-group">
                                <span class="btn btn-xs btn-warning sLoadI-<?php echo $row['id']; ?>"><i
                                        class="fa fa-refresh"></i></span>
                                <span datatype="" class="btn btn-xs btn-info infoBtn" id="<?php echo $row['id']; ?>">مشاهده</span>
                            </div>

                            <div class="btn-group">
                                <span class="btn btn-xs btn-warning sLoadE-<?php echo $row['id']; ?>"><i
                                        class="fa fa-refresh"></i></span>
                                <span datatype="" class="btn btn-xs btn-success editBtn" id="<?php echo $row['id']; ?>">ویرایش</span>
                            </div>
                            <div class="btn-group">
    ...
    $('.infoBtn').click(function (e) {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                setTimeout(function () {
                    window.location.href = "price?id=" + thisId;
                }, 0);
            }
        });
    });
