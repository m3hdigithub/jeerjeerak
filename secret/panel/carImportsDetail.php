        ...
        <table class="table table-bordered table-hover table-striped tablesorter">
            ...
            if ($type && $getID) {
                ...
                if ($information) {
                    ...
                    <tr>
                        <td>نام شرکت</td>
                        <td><?php echo ($info['store_name'] != '') ? $info['store_name'] : '<i class="fa fa-times-circle fa-2x">'; ?></td>
                    </tr>
                    <tr>
                        <td>با مدیریت</td>
                    ...
                    <tr>
                        <td>فکس</td>
                        <td><?php echo ($info['fax'] != '') ? $info['fax'] : '<i class="fa fa-times-circle fa-2x">'; ?></td>
                    </tr>
                    <tr>
                        <td>ایمیل</td>
