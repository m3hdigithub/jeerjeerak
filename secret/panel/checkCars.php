        ...
        <div class="table-responsive">
            ...
            <table class="table table-bordered table-hover table-striped tablesorter">
                ...
                if (isset($_POST['search']) && $_POST['search'] != '' && strlen($_POST['search']) > 0) {
                    $s = $_POST['search'];
                    $search = "name LIKE '%$s%' OR family LIKE '%$s%' OR email LIKE '%$s%' OR mobile LIKE '%$s%'";
                ...
                $status = $row['status'];
                $image = (isset($row['image']) && $row['image'] != '') ? $uploadDirImage . $row['image'] : $defaultImage;
                ?>
                <tr>
                    <td><?php echo $i; ?></td>
                    <td><img src='<?php echo $image; ?>' width='40' height='40'
                    ...
                    <td><?php echo getField($companyTable, 'title', 'id', $row['model_id']); ?></td>
                    <td>
                        <?php if ($status == 1) { ?>
                            <div class="btn-group">
