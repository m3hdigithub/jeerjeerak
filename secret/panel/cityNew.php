...
if (isset($_POST['registerForm'])) {
    ...
    if ($title) {
        ...
        if ($isSubCat == '0') {
            ...
            $ins = $db->query("INSERT INTO $thisTable (sub_cat, title) VALUES('$subCatVal', '$title', '$image')");
            ...
            $class = 'danger';
            $content = 'فقط امکان انتخاب یک شهر می باشد';
        }
    } else {
        $class = 'danger';
...
if (isset($_POST['editForm'])) {
    ...
    if ($subCatVal != $id || 1) {
        ...
        $class = 'danger';
        $content = 'شما نمی توانید یک شهر را به عنوان یک محله برای خودش انتخاب کنید!';
    }
    ...
    <div class="col-lg-12">
        <form action="" method="post" role="form" enctype="multipart/form-data">
            <div class="form-group">
                <label>شهر / محله</label>
                <select name="companyID" class="form-control" id="base">
                    <option value="0" style="color: red;">برای ثبت محله، شهر را انتخاب کنید</option>
                    <?php
            ...
            <div class="form-group">
                <label>نام شهر / محله</label>
                <input type="text" name="title" class="form-control"
                       value="<?php echo $getTitle; ?>"
                       placeholder="نام شهر / محله">
            </div>
