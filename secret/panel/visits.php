...
<div class="col-lg-12">
    ...
    <div class="table-responsive">
        <table class="table table-bordered table-hover table-striped tablesorter">
            ...
            $advInfoName = getField($advertisingTable, 'title', 'id', $row['adv_id']);

            ?>
            <tr>
                <td><?php echo $i; ?></td>
                <td><a href="member?id=<?php echo $row['user_id']; ?>"><?php echo $userInfoName; ?></a></td>
                <td><a href="advertisingDetail?id=<?php echo $row['adv_id']; ?>"><?php echo $advInfoName; ?></a></td>
