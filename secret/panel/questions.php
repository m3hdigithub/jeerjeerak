...
<div class="col-lg-12">
    ...
    <div class="table-responsive">
        ...
        <table class="table table-bordered table-hover table-striped tablesorter">
            ...
            <tr>
                <td><?php echo $i; ?></td>
                <td><?php echo $questions[$row['question_id']]; ?></td>
                <td><?php echo ($row['result'])?'<i class="fa fa-check-circle fa-2x"></i>':'<i class="fa fa-times-circle fa-2x"></i>'; ?></td>
                ...
                <td><a href="advertisingDetail?id=<?php echo $row['adv_id']; ?>"><?php echo $adv; ?></a></td>
